...
export const setTraineeId = createAction('[Current Trainee Id] Set Trainee Id', props<{
  selectedTraineesId: string,
  subject: string
}>());
export const removeTrainee = createAction('[Trainee] Remove Trainee', props<{ id: string, subject:string }>());
